  ...
  Widget _buildTaskCard(TaskItem task, int index) {
    ...
    switch (index) {
      case 0:
        ...
        break;
      case 1:
        backgroundColor = const Color(0xFFE0F7F6); // 第二个卡片底色 - 修正为浅青色
        break;
      case 2:
        backgroundColor = const Color(0xFFFFEEF6); // 第三个卡片底色 - 修正为浅粉色
        break;
      case 3:
        backgroundColor = const Color(0xFFF3EDFF); // 第四个卡片底色 - 修正为浅紫色
        break;
      default:
